import { A as AstroError, k as UnsupportedImageFormat, i as MissingSharp } from './server_Co7d5vRa.mjs';
import { b as baseService, d as detector, p as parseQuality } from './node_D2Dn_RRb.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_BzEpE8kq.mjs').then(n => n.i)).default;
  } catch {
